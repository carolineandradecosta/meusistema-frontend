...
import { Button, Container, Modal, ModalBody, OverlayTrigger, Table, Tooltip } from 'react-bootstrap'
...
const FornecedorList = () => {
  ...
  const removerFornecedor = () => {
    api
    .delete(`/fornecedores/${fornecedorSelecionado.id}`)
    .then(() => {
  ...
  return (
    <Container className="mt-5">
      ...
      <Modal show={modalAberto} onHide={fecharModal} centered>
        ...
        <Modal.Body>
          Tem certeza que deseja excluir o fornecedor:{' '}<strong>{fornecedorSelecionado?.nomeFantasia}
          </strong>
        </Modal.Body>
        <Modal.Footer>
